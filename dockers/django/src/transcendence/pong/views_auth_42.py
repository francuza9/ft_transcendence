...
from .views_utils import fetch_and_save_avatar, create_or_get_username, create_or_get_email
...
def forty_two(request):
    ...
    try:
        ...
        username = create_or_get_username(user_data)
        email = create_or_get_username(user_data)
